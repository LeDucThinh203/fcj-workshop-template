...
The **Smart Parking IoT System** is an end-to-end solution designed for automated parking lot monitoring, Automatic Number Plate Recognition (ANPR), **AWS Lambda AI Chatbot Assistant**, **AWS Lambda AI 7-Day Vehicle Traffic Forecasting Model**, and real-time **AWS AppSync WebSockets Chatbox**. The entire system has been successfully researched and deployed by the team on **AWS Serverless** production environment.
...
* **3.1. [AWS Core Infrastructure](3.1-aws-core-infrastructure/):** Core serverless infrastructure including S3, DynamoDB, Lambda (Backend, ANPR, AI Chatbot, 7-Day Traffic AI Forecast), API Gateway, AWS AppSync (GraphQL & WebSockets Chatbox), AWS IoT Core, CloudFront, and WAF managed via AWS CDK.
...
* **3.3. [IoT Data Pipeline](3.3-iot-data-pipeline/):** Real-time data streaming and processing pipelines connecting edge devices, AWS Lambda, Amazon Rekognition (ANPR), AWS AppSync Subscriptions, 7-Day Traffic Forecasting AI Pipeline, and DynamoDB storage.
* **3.4. [User Interface and Security](3.4-user-interface-and-security/):** Modern Web Dashboard (Admin & User Portals), 7-Day Traffic Forecast AI Chart, AWS AppSync WebSockets Chatbox, AWS Lambda AI Chatbot, and multi-layered security with Amazon Cognito, CloudFront HTTPS, and AWS WAF.
...
* **3.6. [System Testing and Optimization](3.6-system-testing-and-optimization/):** Empirical test results on latency (<2s), plate recognition accuracy (>95%), AI forecasting accuracy, and cost/performance optimizations achieved.